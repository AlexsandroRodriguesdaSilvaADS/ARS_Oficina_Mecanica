...
function gerarOS(event) {
    ...
    function salvarPDF(numeroOS, cliente) {
        ...
        // Limpa o nome do cliente para evitar problemas no nome do arquivo (remove acentos e caracteres especiais)
        ...
        const opcoes = {
            margin: 10,
            filename: `OS_${numeroOS}_${clienteFormatado}.pdf`,
            image: { type: 'jpeg', quality: 0.98 },
            html2canvas: { scale: 2, useCORS: true }, // scale: 2 melhora a resolução. useCORS evita sumir imagens externas.
